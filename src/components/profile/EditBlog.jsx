...
function EditBlog({userId}) {
  ...
  return ( 
    <Col md={8}>
      <FontAwesomeIcon icon={faArrowLeft} onClick={()=>navigate(-1)} style={{fontSize:"1.5rem",cursor:"pointer",marginRight:"4px", marginBottom:"1.2rem"}}/>
    ...
    <Form>
      ...
      <Button variant="primary" type="submit" onClick={fnEditBlog}   className='mt-4' disabled={loading}>edit blog</Button>
    </Form>
  </Col>
   );
}
